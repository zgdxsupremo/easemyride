/**
 * EaseMyRide — Distance & Route Calculation Module
 * 
...
const DistanceService = (() => {
  ...
  async function calculateDistance(origin, destination, serviceType = "oneway") {
    ...
    if (typeof window !== "undefined" && window.EaseMyRideConfig && window.EaseMyRideConfig.googleMapsApiKey && typeof google !== "undefined" && google.maps) {
      try {
